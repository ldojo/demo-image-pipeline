...
_CVSSV3_ATTACKVECTOR = _descriptor.EnumDescriptor(
  name='AttackVector',
  full_name='grafeas.v1beta1.vulnerability.CVSSv3.AttackVector',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_CVSSV3_ATTACKCOMPLEXITY = _descriptor.EnumDescriptor(
  ...
  full_name='grafeas.v1beta1.vulnerability.CVSSv3.AttackComplexity',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_CVSSV3_PRIVILEGESREQUIRED = _descriptor.EnumDescriptor(
  ...
  full_name='grafeas.v1beta1.vulnerability.CVSSv3.PrivilegesRequired',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_CVSSV3_USERINTERACTION = _descriptor.EnumDescriptor(
  ...
  full_name='grafeas.v1beta1.vulnerability.CVSSv3.UserInteraction',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_CVSSV3_SCOPE = _descriptor.EnumDescriptor(
  name='Scope',
  full_name='grafeas.v1beta1.vulnerability.CVSSv3.Scope',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_CVSSV3_IMPACT = _descriptor.EnumDescriptor(
  name='Impact',
  full_name='grafeas.v1beta1.vulnerability.CVSSv3.Impact',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_CVSSV3 = _descriptor.Descriptor(
  name='CVSSv3',
  full_name='grafeas.v1beta1.vulnerability.CVSSv3',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='base_score', full_name='grafeas.v1beta1.vulnerability.CVSSv3.base_score', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='exploitability_score', full_name='grafeas.v1beta1.vulnerability.CVSSv3.exploitability_score', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='impact_score', full_name='grafeas.v1beta1.vulnerability.CVSSv3.impact_score', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='attack_vector', full_name='grafeas.v1beta1.vulnerability.CVSSv3.attack_vector', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='attack_complexity', full_name='grafeas.v1beta1.vulnerability.CVSSv3.attack_complexity', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='privileges_required', full_name='grafeas.v1beta1.vulnerability.CVSSv3.privileges_required', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='user_interaction', full_name='grafeas.v1beta1.vulnerability.CVSSv3.user_interaction', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='scope', full_name='grafeas.v1beta1.vulnerability.CVSSv3.scope', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='confidentiality_impact', full_name='grafeas.v1beta1.vulnerability.CVSSv3.confidentiality_impact', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='integrity_impact', full_name='grafeas.v1beta1.vulnerability.CVSSv3.integrity_impact', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='availability_impact', full_name='grafeas.v1beta1.vulnerability.CVSSv3.availability_impact', index=10,
...
CVSSv3 = _reflection.GeneratedProtocolMessageType('CVSSv3', (_message.Message,), {
  'DESCRIPTOR' : _CVSSV3,
  '__module__' : 'proto.v1beta1.cvss_pb2'
  # @@protoc_insertion_point(class_scope:grafeas.v1beta1.vulnerability.CVSSv3)
  })
