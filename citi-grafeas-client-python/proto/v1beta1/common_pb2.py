...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='proto/v1beta1/common.proto',
  package='grafeas.v1beta1',
  syntax='proto3',
  serialized_options=b'\n\022io.grafeas.v1beta1P\001Z8github.com/grafeas/grafeas/proto/v1beta1/common_go_proto\242\002\003GRA',
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n\x1aproto/v1beta1/common.proto\x12\x0fgrafeas.v1beta1\"(\n\nRelatedUrl\x12\x0b\n\x03url\x18\x01 \x01(\t\x12\r\n\x05label\x18\x02 \x01(\t\"5\n\tSignature\x12\x11\n\tsignature\x18\x01 \x01(\x0c\x12\x15\n\rpublic_key_id\x18\x02 \x01(\t*\x97\x01\n\x08NoteKind\x12\x19\n\x15NOTE_KIND_UNSPECIFIED\x10\x00\x12\x11\n\rVULNERABILITY\x10\x01\x12\t\n\x05\x42UILD\x10\x02\x12\t\n\x05IMAGE\x10\x03\x12\x0b\n\x07PACKAGE\x10\x04\x12\x0e\n\nDEPLOYMENT\x10\x05\x12\r\n\tDISCOVERY\x10\x06\x12\x0f\n\x0b\x41TTESTATION\x10\x07\x12\n\n\x06INTOTO\x10\x08\x42V\n\x12io.grafeas.v1beta1P\x01Z8github.com/grafeas/grafeas/proto/v1beta1/common_go_proto\xa2\x02\x03GRAb\x06proto3'
)
...
_SIGNATURE = _descriptor.Descriptor(
  name='Signature',
  full_name='grafeas.v1beta1.Signature',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='signature', full_name='grafeas.v1beta1.Signature.signature', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='public_key_id', full_name='grafeas.v1beta1.Signature.public_key_id', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
RelatedUrl = _reflection.GeneratedProtocolMessageType('RelatedUrl', (_message.Message,), {
  ...
  '__module__' : 'proto.v1beta1.common_pb2'
