...
_SOURCE.fields_by_name['context'].message_type = proto_dot_v1beta1_dot_source__pb2._SOURCECONTEXT
_SOURCE.fields_by_name['additional_contexts'].message_type = proto_dot_v1beta1_dot_source__pb2._SOURCECONTEXT
...
BuildProvenance = _reflection.GeneratedProtocolMessageType('BuildProvenance', (_message.Message,), {
  ...
  'BuildOptionsEntry' : _reflection.GeneratedProtocolMessageType('BuildOptionsEntry', (_message.Message,), {
    ...
    '__module__' : 'proto.v1beta1.provenance_pb2'
